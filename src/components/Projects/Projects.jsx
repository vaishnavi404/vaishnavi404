...
const webItem = [
  ...
  {
    // link: 'https://github.com/vaishnavi404/optimizing-crop-production',
    title: 'Precision Farming Optimization',
    techStack:
      'Technology used: Pandas, Numpy, Seaborn, ipywidgets, matplotlib, sklearn.cluster, Zod',
    desc: 'Utilizing ML and DS, our Precision Farming Optimization project analyzes climate and soil data to forecast optimal conditions for crops, empowering farmers with data-driven insights to maximize productivity and sustainability.',
    image: farming,
    color: '#D2E0FB',
    githubLink: 'https://github.com/vaishnavi404/optimizing-crop-production'
  },
  {
